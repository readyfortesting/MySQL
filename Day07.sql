...
------------------------------------------------------------------------------*/
select isim, maas  -- ustteki verilen isimleri tablo ismi olarak kabul etmiş, isim,maas
from personel      --  isim alt tabloda isim, maas alt tablodak, maas ayni sirada olmali,alt alta yani
where maas>4000
union
select sehir, maas
from personel
...
/* -----------------------------------------------------------------------------
  ORNEK3: Honda,Ford ve Tofas'ta calisan ortak isimde personelin isimlerini listeleyin
------------------------------------------------------------------------------*/  
select isim
from personel
where sirket='Honda'
...
--  ***** tekrarlilar la gelsin istersek union all yazariz.
...
select isim,maas,sirket
from personel
where sirket !='Honda';  -- <> da kullanabiliriz != yerine
