...
/* -----------------------------------------------------------------------------
 ...
 -----------------------------------------------------------------------------*/ 
  -- drop koca binayi
  -- delete sadece bir ögrenciyi siler
...
/* ----------------------------------------------------------------------------
 ...
 -----------------------------------------------------------------------------*/     
    ...
    delete from ogrenciler where id='123' or id='125' or id='126';   -- 2.yontem
    
/* ----------------------------------------------------------------------------
  ORNEK7:  TABLODAKİ TÜM KAYITLARI SİLELİM..
 -----------------------------------------------------------------------------*/     
   delete from ogrenciler;
   -- ogrenciler tablosuna dokunma ama icerdekileri sil demek.
   -- tablonun da silinebilmesi icin drop table yapabiliriz.
...
==============================================================================*/ 
    ...
    savepoint abc;
    select * from ogrenciler;
    delete  from ogrenciler; -- icindeki verile siler
    rollback to abc;  -- silinen verileri geri getirir.