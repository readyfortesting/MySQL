...
/* -----------------------------------------------------------------------------
 ...
 -----------------------------------------------------------------------------*/ 
    update tedarikciler
    set firma_ismi='casper', irtibat_ismi='Ali Veli' -- and degil virgulle yazariz
    where vergi_no=101;
...
/*-----------------------------------------------------------------------------
 ...
 degistiriniz.
 -----------------------------------------------------------------------------*/
   delete from tedarikciler; -- once sileriz
   -- sonra tedarikcilerin insert'lerini tekrar yapiyoruz. 
   -- ondan sonra urunlerin insert'lerini de tekrar yapmamiz gerekiyor
   update urunler   
...
/*------------------------------------------------------------------------------
 ...
 -----------------------------------------------------------------------------*/
 update urunler
 set musteri_isim=(select firma_ismi from tedarikciler where irtibat_ismi='Adam Eve')
